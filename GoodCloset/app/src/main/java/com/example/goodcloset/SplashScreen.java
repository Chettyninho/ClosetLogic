...
public class SplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgbg.animate().translationY(-2500).setDuration(800).setStartDelay(3000);
        //logo.animate().translationY(-1400).setDuration(1000).setStartDelay(4000);
        appname.animate().translationY(-1400).setDuration(800).setStartDelay(3000);
        lottieAnimationView.animate().translationY(-1700).setDuration(800).setStartDelay(3000);
        powered.animate().translationY(-1900).setDuration(800).setStartDelay(3000);
